...
eye_detector_path = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_eye.xml')
nose_detector_path = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_mcs_nose.xml')
